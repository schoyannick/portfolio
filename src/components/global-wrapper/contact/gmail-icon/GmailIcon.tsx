...
import { StyledGmailIconWrapper, StyledGmailText, StyledToolTip } from './StyledGmailIcon';

const GmailIcon: React.FC = () => {
    const [didCopy, setDidCopy] = useState(false);

    return (
        <StyledGmailIconWrapper>
            <a
                href="mailto:scho.yannick@gmail.com"
                target="_blank"
                rel="noreferrer"
            >
                <svg 
            ...
            >
                ...
                <div>scho.yannick@gmail.com</div>
            </StyledGmailText>
        </StyledGmailIconWrapper>
    );
};
